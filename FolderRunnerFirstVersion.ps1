...
# Document library (pas aan indien nodig)
...
# Hulpfunctie: lookup-ID ophalen (en cachen) op basis van stationnummer
...
foreach ($eqFolder in $equipmentFolders) {
    ...
    $equipmentFolderName = $eqFolder.Name        # bv. "1 Mechanical"

    # EquipmentDocument afleiden:
    # "1 Mechanical" -> "1. Mechanical"
    $equipmentDocument = $equipmentFolderName -replace " ", ". ", 1
